...
function Home() {
  ...
  function addCard(title, boardId) {
    ...
    newBoards[index] = {
      ...newBoards[index],
      cards: [...newBoards[index].cards, card],
    };
  ...
  function handleDragEnd(cardId, boardId) {
    ...
    const activity =
      "moved from " + "" + tempBoards[s_boardIndex].title + " " + date;

    tempBoards[t_boardIndex].cards[t_cardIndex] = {
      ...tempBoards[t_boardIndex].cards[t_cardIndex],
      activities: [
        activity,
        ...tempBoards[t_boardIndex].cards[t_cardIndex].activities,
      ],
    };
  ...
  function handleDragEndb(boardId) {
    ...
    let targetBoardIndex = boards.findIndex(
      (board) => board.id == targetb.boardId
    );
