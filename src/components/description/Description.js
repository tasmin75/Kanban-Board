...
function Description(props) {
  ...
  const cardIndex =
    board && board.cards.findIndex((card) => card.id === local.cardId);
    ...
    <div>
      <Dialog className={styles.dialog} open={open}>
        ...
        <DialogContent sx={{ width: "500px", height: "650px" }}>
          <div className={styles.b_location}>
            In the List<h5> {board.title} </h5>
          </div>
          ...
          <div className={styles.activity}>
            <div className={styles.activity_top}>
              ...
              <Button onClick={() => setShowDetails(!showDetails)}>
                {showDetails ? <p>close Details</p> : <p>Show Details</p>}
              </Button>
            </div>
